import{r as M,_ as q,C as W,a as z,E as X,o as Rn,F as Y,L as kt,g as A,i as St,b as Cn,v as Nn,c as Qe,d as At,e as le,f as On,h as bt,j as Ln,k as w,l as Le,p as Mn,u as Dn,q as Q,m,n as Un,s as Fn,S as Z,t as xn,w as Vn,x as Pt,y as $n,z as Hn,A as qn,B as Wn,D as jn}from"./index.esm-CtTi9zbD.js";var zn="firebase",Bn="12.7.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ti({appConfig:n,heartbeatServiceProvider:e},{fid:t}){const i=Mt(n),r=Ft(n),s=e.getImmediate({optional:!0});if(s){const l=await s.getHeartbeatsHeader();l&&r.append("x-firebase-client",l)}const a={fid:t,authVersion:Ot,appId:n.appId,sdkVersion:Nt},o={method:"POST",headers:r,body:JSON.stringify(a)},c=await xt(()=>fetch(i,o));if(c.ok){const l=await c.json();return{fid:l.fid||t,registrationStatus:2,refreshToken:l.refreshToken,authToken:Dt(l.authToken)}}else throw await Ut("Create Installation",c)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $t=new Map;function Ht(n,e){const t=_e(n);qt(t,e),ai(t,e)}function qt(n,e){const t=$t.get(n);if(t)for(const i of t)i(e)}function ai(n,e){const t=oi();t&&t.postMessage({key:n,fid:e}),ci()}let N=null;function oi(){return!N&&"BroadcastChannel"in self&&(N=new BroadcastChannel("[Firebase] FID Change"),N.onmessage=n=>{qt(n.data.key,n.data.fid)}),N}function ci(){$t.size===0&&N&&(N.close(),N=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const li="firebase-installations-database",ui=1,U="firebase-installations-store";let ke=null;function De(){return ke||(ke=Rn(li,ui,{upgrade:(n,e)=>{switch(e){case 0:n.createObjectStore(U)}}})),ke}async function ue(n,e){const t=_e(n),r=(await De()).transaction(U,"readwrite"),s=r.objectStore(U),a=await s.get(t);return await s.put(e,t),await r.done,(!a||a.fid!==e.fid)&&Ht(n,e.fid),e}async function Wt(n){const e=_e(n),i=(await De()).transaction(U,"readwrite");await i.objectStore(U).delete(e),await i.done}async function we(n,e){const t=_e(n),r=(await De()).transaction(U,"readwrite"),s=r.objectStore(U),a=await s.get(t),o=e(a);return o===void 0?await s.delete(t):await s.put(o,t),await r.done,o&&(!a||a.fid!==o.fid)&&Ht(n,o.fid),o}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ki(n){const e=n,{installationEntry:t,registrationPromise:i}=await Ue(e);return i?i.catch(console.error):Fe(e).catch(console.error),t.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Si(n,e=!1){const t=n;return await Ai(t),(await Fe(t,e)).token}async function Ai(n){const{registrationPromise:e}=await Ue(n);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const de="analytics",Oi="firebase_id",Li="origin",Mi=60*1e3,Di="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",xe="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fi(n){if(!n.startsWith(xe)){const e=g.create("invalid-gtag-resource",{gtagURL:n});return p.warn(e.message),""}return n}function Gt(n){return Promise.all(n.map(e=>e.catch(t=>t)))}function xi(n,e){let t;return window.trustedTypes&&(t=window.trustedTypes.createPolicy(n,e)),t}function Vi(n,e){const t=xi("firebase-js-sdk-policy",{createScriptURL:Fi}),i=document.createElement("script"),r=`${xe}?l=${n}&id=${e}`;i.src=t?t==null?void 0:t.createScriptURL(r):r,i.async=!0,document.head.appendChild(i)}function $i(n){let e=[];return Array.isArray(window[n])?e=window[n]:window[n]=e,e}async function Hi(n,e,t,i,r,s){const a=i[r];try{if(a)await e[a];else{const c=(await Gt(t)).find(l=>l.measurementId===r);c&&await e[c.appId]}}catch(o){p.error(o)}n("config",r,s)}async function qi(n,e,t,i,r){try{let s=[];if(r&&r.send_to){let a=r.send_to;Array.isArray(a)||(a=[a]);const o=await Gt(t);for(const c of a){const l=o.find(h=>h.measurementId===c),d=l&&e[l.appId];if(d)s.push(d);else{s=[];break}}}s.length===0&&(s=Object.values(e)),await Promise.all(s),n("event",i,r||{})}catch(s){p.error(s)}}function Wi(n,e,t,i){async function r(s,...a){try{if(s==="event"){const[o,c]=a;await qi(n,e,t,o,c)}else if(s==="config"){const[o,c]=a;await Hi(n,e,t,i,o,c)}else if(s==="consent"){const[o,c]=a;n("consent",o,c)}else if(s==="get"){const[o,c,l]=a;n("get",o,c,l)}else if(s==="set"){const[o]=a;n("set",o)}else n(s,...a)}catch(o){p.error(o)}}return r}function ji(n,e,t,i,r){let s=function(...a){window[i].push(arguments)};return window[r]&&typeof window[r]=="function"&&(s=window[r]),window[r]=Wi(s,n,e,t),{gtagCore:s,wrappedGtag:window[r]}}function zi(n){const e=window.document.getElementsByTagName("script");for(const t of Object.values(e))if(t.src&&t.src.includes(xe)&&t.src.includes(n))return t;return null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sr{constructor(e){this.app=e}_delete(){return delete x[this.app.options.appId],Promise.resolve()}}let x={},tt=[];const nt={};let Ae="dataLayer",ar="gtag",it,Ve,rt=!1;function or(){const n=[];if(St()&&n.push("This is a browser extension environment."),On()||n.push("Cookies are not available."),n.length>0){const e=n.map((i,r)=>`(${r+1}) ${i}`).join(" "),t=g.create("invalid-analytics-context",{errorInfo:e});p.warn(t.message)}}function cr(n,e,t){or();const i=n.options.appId;if(!i)throw g.create("no-app-id");if(!n.options.apiKey)if(n.options.measurementId)p.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${n.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw g.create("no-api-key");if(x[i]!=null)throw g.create("already-exists",{id:i});if(!rt){$i(Ae);const{wrappedGtag:s,gtagCore:a}=ji(x,tt,nt,Ae,ar);Ve=s,it=a,rt=!0}return x[i]=rr(n,tt,nt,e,it,Ae,t),new sr(n)}function lr(n=At()){n=A(n);const e=z(n,de);return e.isInitialized()?e.getImmediate():ur(n)}function ur(n,e={}){const t=z(n,de);if(t.isInitialized()){const r=t.getImmediate();if(le(e,t.getOptions()))return r;throw g.create("already-initialized")}return t.initialize({options:e})}function dr(n,e,t){n=A(n),nr(Ve,x[n.app.options.appId],e,t).catch(i=>p.error(i))}function hr(n,e,t,i){n=A(n),tr(Ve,x[n.app.options.appId],e,t,i).catch(r=>p.error(r))}const st="@firebase/analytics",at="0.10.19";function fr(){q(new W(de,(e,{options:t})=>{const i=e.getProvider("app").getImmediate(),r=e.getProvider("installations-internal").getImmediate();return cr(i,r,t)},"PUBLIC")),q(new W("analytics-internal",n,"PRIVATE")),M(st,at),M(st,at,"esm2020");function n(e){try{const t=e.getProvider(de).getImmediate();return{logEvent:(i,r,s)=>hr(t,i,r,s),setUserProperties:(i,r)=>dr(t,i,r)}}catch(t){throw g.create("interop-component-reg-failed",{reason:t})}}}fr();function Xt(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const pr=Xt,Yt=new X("auth","Firebase",Xt());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ee{constructor(e,t){this.shortDelay=e,this.longDelay=t,S(t>e,"Short delay should be less than long delay!"),this.isMobile=xn()||Vn()}get(){return _r()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ur(n,e={}){return B(n,"GET","/v2/passwordPolicy",We(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fr=6;class xr{constructor(e){var i;const t=e.customStrengthOptions;this.customStrengthOptions={},this.customStrengthOptions.minPasswordLength=t.minPasswordLength??Fr,t.maxPasswordLength&&(this.customStrengthOptions.maxPasswordLength=t.maxPasswordLength),t.containsLowercaseCharacter!==void 0&&(this.customStrengthOptions.containsLowercaseLetter=t.containsLowercaseCharacter),t.containsUppercaseCharacter!==void 0&&(this.customStrengthOptions.containsUppercaseLetter=t.containsUppercaseCharacter),t.containsNumericCharacter!==void 0&&(this.customStrengthOptions.containsNumericCharacter=t.containsNumericCharacter),t.containsNonAlphanumericCharacter!==void 0&&(this.customStrengthOptions.containsNonAlphanumericCharacter=t.containsNonAlphanumericCharacter),this.enforcementState=e.enforcementState,this.enforcementState==="ENFORCEMENT_STATE_UNSPECIFIED"&&(this.enforcementState="OFF"),this.allowedNonAlphanumericCharacters=((i=e.allowedNonAlphanumericCharacters)==null?void 0:i.join(""))??"",this.forceUpgradeOnSignin=e.forceUpgradeOnSignin??!1,this.schemaVersion=e.schemaVersion}validatePassword(e){const t={isValid:!0,passwordPolicy:this};return this.validatePasswordLengthOptions(e,t),this.validatePasswordCharacterOptions(e,t),t.isValid&&(t.isValid=t.meetsMinPasswordLength??!0),t.isValid&&(t.isValid=t.meetsMaxPasswordLength??!0),t.isValid&&(t.isValid=t.containsLowercaseLetter??!0),t.isValid&&(t.isValid=t.containsUppercaseLetter??!0),t.isValid&&(t.isValid=t.containsNumericCharacter??!0),t.isValid&&(t.isValid=t.containsNonAlphanumericCharacter??!0),t}validatePasswordLengthOptions(e,t){const i=this.customStrengthOptions.minPasswordLength,r=this.customStrengthOptions.maxPasswordLength;i&&(t.meetsMinPasswordLength=e.length>=i),r&&(t.meetsMaxPasswordLength=e.length<=r)}validatePasswordCharacterOptions(e,t){this.updatePasswordCharacterOptionsStatuses(t,!1,!1,!1,!1);let i;for(let r=0;r<e.length;r++)i=e.charAt(r),this.updatePasswordCharacterOptionsStatuses(t,i>="a"&&i<="z",i>="A"&&i<="Z",i>="0"&&i<="9",this.allowedNonAlphanumericCharacters.includes(i))}updatePasswordCharacterOptionsStatuses(e,t,i,r,s){this.customStrengthOptions.containsLowercaseLetter&&(e.containsLowercaseLetter||(e.containsLowercaseLetter=t)),this.customStrengthOptions.containsUppercaseLetter&&(e.containsUppercaseLetter||(e.containsUppercaseLetter=i)),this.customStrengthOptions.containsNumericCharacter&&(e.containsNumericCharacter||(e.containsNumericCharacter=r)),this.customStrengthOptions.containsNonAlphanumericCharacter&&(e.containsNonAlphanumericCharacter||(e.containsNonAlphanumericCharacter=s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Be={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function $r(n){Be=n}function Hr(n){return Be.loadJS(n)}function qr(){return Be.gapiScript}function Wr(n){return`__${n}${Math.floor(Math.random()*1e6)}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function H(n,e){return Er(n,"POST","/v1/accounts:signInWithIdp",We(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class C extends te{constructor(){super("twitter.com")}static credential(e,t){return F._fromParams({providerId:C.PROVIDER_ID,signInMethod:C.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return C.credentialFromTaggedObject(e)}static credentialFromError(e){return C.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:i}=e;if(!t||!i)return null;try{return C.credential(t,i)}catch{return null}}}C.TWITTER_SIGN_IN_METHOD="twitter.com";C.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xs=new ee(5e3,15e3),Vs="__/auth/iframe",$s="emulator/auth/iframe",Hs={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},qs=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Ws(n){const e=n.config;u(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?qe(e,$s):`https://${n.config.authDomain}/${Vs}`,i={apiKey:e.apiKey,appName:n.name,v:Z},r=qs.get(n.config.apiHost);r&&(i.eid=r);const s=n._getFrameworks();return s.length&&(i.fw=s.join(",")),`${t}?${Q(i).slice(1)}`}async function js(n){const e=await Fs(n),t=y().gapi;return u(t,n,"internal-error"),e.open({where:document.body,url:Ws(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Hs,dontclear:!0},i=>new Promise(async(r,s)=>{await i.restyle({setHideOnLeave:!1});const a=_(n,"network-request-failed"),o=y().setTimeout(()=>{s(a)},xs.get());function c(){y().clearTimeout(o),r(i)}i.ping(c).then(c,()=>{s(a)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sa(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function aa(n){q(new W("auth",(e,{options:t})=>{const i=e.getProvider("app").getImmediate(),r=e.getProvider("heartbeat"),s=e.getProvider("app-check-internal"),{apiKey:a,authDomain:o}=i.options;u(a&&!a.includes(":"),"invalid-api-key",{appName:i.name});const c={apiKey:a,authDomain:o,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:hn(n)},l=new Vr(i,r,s,c);return zr(l,t),l},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,i)=>{e.getProvider("auth-internal").initialize()})),q(new W("auth-internal",e=>{const t=ye(e.getProvider("auth").getImmediate());return(i=>new ra(i))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),M(Tt,vt,sa(n)),M(Tt,vt,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
