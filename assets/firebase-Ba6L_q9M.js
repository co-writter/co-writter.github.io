import{r as y,_ as T,C as A,a as k,E as X,o as Ie,F as Y,L as ye,g as F,i as be,b as Te,v as Ae,c as q,d as ve,e as Se,f as ke,h as Ee}from"./index.esm-CIvlP5Sc.js";import{GoogleAuthProvider as Re,getAuth as Ce}from"./index.esm-jBoJwvNd.js";import{signInWithPopup as ln}from"./index.esm-jBoJwvNd.js";import{getFirestore as Pe}from"./index.esm-r3RIfZqZ.js";var _e="firebase",De="12.7.0";/**
 * @license
 ...
 */y(_e,De,"app");const J="@firebase/installations",O="0.6.19";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Q=1e4,Z=`w:${O}`,ee="FIS_v2",Fe="https://firebaseinstallations.googleapis.com/v1",Oe=3600*1e3,Me="installations",$e="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Be=/^[cdef][\w-]{21}$/,D="";function Ve(){try{const e=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(e),e[0]=112+e[0]%16;const n=ze(e);return Be.test(n)?n:D}catch{return D}}function ze(e){return Ue(e).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const We="firebase-installations-database",Xe=1,w="firebase-installations-store";let C=null;function M(){return C||(C=Ie(We,Xe,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(w)}}})),C}async function v(e,t){const n=E(e),i=(await M()).transaction(w,"readwrite"),r=i.objectStore(w),s=await r.get(n);return await r.put(t,n),await i.done,(!s||s.fid!==t.fid)&&le(e,t.fid),t}async function de(e){const t=E(e),a=(await M()).transaction(w,"readwrite");await a.objectStore(w).delete(t),await a.done}async function R(e,t){const n=E(e),i=(await M()).transaction(w,"readwrite"),r=i.objectStore(w),s=await r.get(n),o=t(s);return o===void 0?await r.delete(n):await r.put(o,n),await i.done,o&&(!s||s.fid!==o.fid)&&le(e,o.fid),o}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $(e){let t;const n=await R(e.appConfig,a=>{const i=Ye(a),r=Je(e,i);return t=r.registrationPromise,r.installationEntry});return n.fid===D?{installationEntry:await t}:{installationEntry:n,registrationPromise:t}}function Ye(e){const t=e||{fid:Ve(),registrationStatus:0};return fe(t)}function Je(e,t){if(t.registrationStatus===0){if(!navigator.onLine){const i=Promise.reject(m.create("app-offline"));return{installationEntry:t,registrationPromise:i}}const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},a=Qe(e,n);return{installationEntry:n,registrationPromise:a}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:Ze(e)}:{installationEntry:t}}async function Qe(e,t){try{const n=await je(e,t);return v(e.appConfig,n)}catch(n){throw te(n)&&n.customData.serverCode===409?await de(e.appConfig):await v(e.appConfig,{fid:t.fid,registrationStatus:0}),n}}async function Ze(e){let t=await j(e.appConfig);for(;t.registrationStatus===1;)await oe(100),t=await j(e.appConfig);if(t.registrationStatus===0){const{installationEntry:n,registrationPromise:a}=await $(e);return a||n}return t}function j(e){return R(e,t=>{if(!t)throw m.create("installation-not-found");return fe(t)})}function fe(e){return et(e)?{fid:e.fid,registrationStatus:0}:e}function et(e){return e.registrationStatus===1&&e.registrationTime+Q<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function N(e,t=!1){let n;const a=await R(e.appConfig,r=>{if(!pe(r))throw m.create("not-registered");const s=r.authToken;if(!t&&rt(s))return r;if(s.requestStatus===1)return n=at(e,t),r;{if(!navigator.onLine)throw m.create("app-offline");const o=ot(r);return n=it(e,o),o}});return n?await n:a.authToken}async function at(e,t){let n=await U(e.appConfig);for(;n.authToken.requestStatus===1;)await oe(100),n=await U(e.appConfig);const a=n.authToken;return a.requestStatus===0?N(e,t):a}function U(e){return R(e,t=>{if(!pe(t))throw m.create("not-registered");const n=t.authToken;return ct(n)?{...t,authToken:{requestStatus:0}}:t})}async function it(e,t){try{const n=await tt(e,t),a={...t,authToken:n};return await v(e.appConfig,a),n}catch(n){if(te(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await de(e.appConfig);else{const a={...t,authToken:{requestStatus:0}};await v(e.appConfig,a)}throw n}}function pe(e){return e!==void 0&&e.registrationStatus===2}function rt(e){return e.requestStatus===2&&!st(e)}function st(e){const t=Date.now();return t<e.creationTime||e.creationTime+e.expiresIn<t+Oe}function ot(e){const t={requestStatus:1,requestTime:Date.now()};return{...e,authToken:t}}function ct(e){return e.requestStatus===1&&e.requestTime+Q<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Bt(){if(Te())try{await Ae()}catch(e){return u.warn(d.create("indexeddb-unavailable",{errorInfo:e==null?void 0:e.toString()}).message),!1}else return u.warn(d.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function Vt(e,t,n,a,i,r,s){const o=Nt(e);o.then(g=>{n[g.measurementId]=g.appId,e.options.measurementId&&g.measurementId!==e.options.measurementId&&u.warn(`The measurement ID in the local Firebase config (${e.options.measurementId}) does not match the measurement ID fetched from the server (${g.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(g=>u.error(g)),t.push(o);const c=Bt().then(g=>{if(g)return a.getId()}),[l,f]=await Promise.all([o,c]);_t(r)||St(r,l.measurementId),i("js",new Date);const p=(s==null?void 0:s.config)??{};return p[It]="firebase",p.update=!0,f!=null&&(p[wt]=f),i("config",l.measurementId,p),l.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
