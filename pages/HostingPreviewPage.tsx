...
const HostingPreviewPage: React.FC = () => {
  ...
  // Simulate fetching from "GitHub Repo"
  useEffect(() => {
    setIsLoading(true);
    // In a real app, this would fetch from `https://raw.githubusercontent.com/...`
    // We simulate by finding the mock user with matching slug/username
    setTimeout(() => {
