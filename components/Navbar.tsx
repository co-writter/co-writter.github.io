...
const Navbar: React.FC = () => {
    ...
    return (
        <>
            ...
            {/* Optimized transition: duration-300 with ease-obsidian */}
            <nav className="fixed top-0 left-0 right-0 w-full z-50 h-16 border-b border-white/5 bg-[#000000]/60 backdrop-blur-xl shadow-[0_4px_30px_rgba(0,0,0,0.1)] transition-all duration-300 ease-obsidian animate-slide-down will-change-transform">
                <div className="max-w-[1400px] mx-auto px-6 h-full flex items-center justify-between">

                    {/* Logo */}
                    <Link to="/" className="flex items-center gap-3 group z-50 relative">
                        <MorphicEye className="w-9 h-9 border border-white/20 bg-[#111] shadow-[0_0_10px_rgba(255,255,255,0.1)] rounded-full transition-transform duration-300 ease-obsidian group-hover:scale-110 will-change-transform" />
